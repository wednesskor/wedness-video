...
export default function VideoScrollHero() {
  ...
  return (
    <section ref={containerRef} className="relative w-full h-[600vh] bg-black">
      ...
      >
        {/* 70% width, 70% height Container */}
        <div className="relative w-[70vw] h-[70vh] rounded-2xl overflow-hidden shadow-[0_0_60px_rgba(0,0,0,0.9)] border border-white/10 flex items-center justify-center bg-black">
